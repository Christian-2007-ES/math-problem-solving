...
\section{Desigualdades}
	...
	Sean $a,b,c$ números reales positivos tales que $a^2+b^2+c^2=1$. Probar que
	\begin{center}
		$\left(\dfrac{1}{a^3(b+c)^5}+\dfrac{1}{b^3(c+a)^5}+\dfrac{1}{c^3(a+b)^5}\right)^{1/5}\geq\dfrac{3}{2}$.
	\end{center}
		\textbf{Solución:} Usando la notación de sumatorio cíclico la desigualdad se convierte en
	\begin{center}
		$\displaystyle\left(\sum_{cyc}\dfrac{1}{a^3(b+c)^5}\right)^{1/5}\geq\dfrac{3}{2}$.
	\end{center}
\end{document}